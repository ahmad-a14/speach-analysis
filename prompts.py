...
Topic Extraction: (in english) Identify and list the main topics or keywords present in the user's message.

Summary: (in english) Provide a concise summary of the user's message, capturing the main points.
...
*Important*
- Always give response in english. Ignore the input language.
"""